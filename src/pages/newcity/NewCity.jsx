...
export default function NewCity() {
  ...
  return (
    ...
    <div className='divTituloNewcity'>
            <h2 className='tituloNewCity'>Create new City<span className="rojo">.</span></h2>
    </div>
    <div className='newcity'>
        ...
        <form className='formNewCity' onSubmit={newCity} ref={form}>
            ...
            <label>Continent
                <input type="text" name= "continentCity" ref={continentCity} required />
            </label>
            <label>Choose a picture of city</label>           
            
            <input type="file" name="photoCity" accept=".jpg" ref={picture} required id='photo'/>
            <label>Population
                <input type="number" name= "populationCity" ref={population} required />
            </label>
